...
IFJCOMP_EXECUTABLE = "../project-mundik/bin/IFJ"
...
IMPLEMENTED_EXTENTIONS = EXTEND_ALL
...
tests = [
    ...
    ("factorial.py",  [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE], "a",  EXTEND_NONE, EXTEND_NONE),
    ("factorial.py",  [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE], None, EXTEND_NONE, EXTEND_NONE),
    ("factorial2.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE], "a",  EXTEND_NONE, EXTEND_NONE),
    ("factorial2.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE], None, EXTEND_NONE, EXTEND_NONE),

    # Lexical analysis tests
    ("badcomment.py",    [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("baddot.py",        [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badchars.py",      [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badcomment2.py",   [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badexponent.py",   [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badindent2.py",    [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badstring.py",     [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("emptyexponent.py", [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("morezeroes.py",    [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("nonasci.py",       [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badfunction5.py",  [ERR_COMP_LEX], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badindent.py",     [ERR_COMP_LEX, ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE), # Unclear if this should be syntax or lexical error

    # Syntax analysis tests
    ("badfunction.py",  [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badfunction2.py", [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badfunction3.py", [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badfunction4.py", [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badfunction7.py", [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badindent3.py",   [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badwhile.py",     [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badwhile2.py",    [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badwhile3.py",    [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badif.py",        [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badif2.py",       [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badif3.py",       [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badcall.py",      [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badcall2.py",     [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badcall3.py",     [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badexpr.py",      [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badexpr2.py",     [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badexpr3.py",     [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badexpr4.py",     [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badexpr5.py",     [ERR_COMP_SYN], [], None, EXTEND_NONE, EXTEND_NONE),
    ("badreturn.py",    [ERR_COMP_SYN], [], None, EXTEND_NONE, [EXTEND_FUNEXP]),

    # Semantics analysis tests
    ("badvar3.py",       [ERR_COMP_SEM_DEF], [], None, EXTEND_NONE, EXTEND_NONE),
    ...
    ("badbuildin.py",  [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE],     None, EXTEND_NONE, EXTEND_NONE),
    ("badbuildin2.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE],     None, EXTEND_NONE, EXTEND_NONE),
    ("badbuildin3.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE],     None, EXTEND_NONE, EXTEND_NONE),
    ("badbuildin6.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE],     None, EXTEND_NONE, EXTEND_NONE),
    ("badbuildin7.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE],     None, EXTEND_NONE, EXTEND_NONE),
    ("badbuildin4.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE],     None, EXTEND_NONE, EXTEND_NONE),
    ("badbuildin5.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE], [ERR_INT_RUN_OPER, ERR_COMP_SEM_TYPE],     None, EXTEND_NONE, EXTEND_NONE),
    ("badbuildin8.py", [ERR_COMP_OK, ERR_COMP_SEM_TYPE, ERR_COMP_SEM_OTHER], [ERR_INT_RUN_STRING, ERR_COMP_SEM_OTHER, ERR_COMP_SEM_TYPE], None, EXTEND_NONE, EXTEND_NONE),
